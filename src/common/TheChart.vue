...
import HCMore from "highcharts/highcharts-more"; // Optional - if using polar charts
HCMore(Highcharts);
...
data() {
    ...
    chartOptions: {
        ...
        subtitle: {
        text:
            'Source: <a href="https://en.wikipedia.org/wiki/All-time_Olympic_Games_medal_table" target="_blank">Wikipedia</a>',
        align: "left",
        },
        tooltip: {
        outside: true,
